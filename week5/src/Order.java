...
public class Order {
    ...
    public DigitalVideoDisc getALuckyItem(){
        ...
        int num_item = this.getQtyOrdered();
        int lucky_item = rd.nextInt(num_item-1);

        return itemsOrdered[lucky_item];
    }
    ...
    public float totalCost(){
        ...
        DigitalVideoDisc lucky_item = getALuckyItem();

        total -= lucky_item.getCost();
        return total;
    }
}
